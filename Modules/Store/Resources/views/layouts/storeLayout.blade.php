...
<body class="bg-white horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover"
      data-menu="horizontal-menu" id="store-body">
@livewireScripts
<!-- BEGIN: Header-->
<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center"
    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav">
            <li class="nav-item">
                <a class="navbar-brand" href="../../../html/rtl/horizontal-menu-template/index.html"><span
                        class="brand-logo">
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand"
                                                href="../../../html/rtl/horizontal-menu-template/index.html"><span
                            class="brand-logo">
                                <svg viewbox="0 0 139 95" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                     xmlns:xlink="http://www.w3.org/1999/xlink" height="24">
                                    <defs>
                    ...
                    @if(count($category->children) > 0 )
                        <li class="dropdown nav-item" data-menu="dropdown">
                            <a class="dropdown-toggle  nav-link d-flex align-items-center"
                               href="{{route('store.shopCategory',[$store->store_link,$category->id])}}">
                ...
                <div class="store-data mb-2">
                    ...
                    <div>
                        @if($store->instagram_link)
                            <a href="https://instagram.com/{{$store->instagram_link}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                        ...
                        @if($store->snapchat_link)
                            <a href="https://snapchat.com/{{$store->snapchat_link}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        @if($store->twitter_link)
                            <a href="https://twitter.com/{{$store->twitter_link}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        @if($store->tiktok_link)
                            <a href="https://tiktok.com/{{$store->tiktok_link}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <i class="fab fa-tiktok"></i>
                            </a>
                        @endif
                        @if($store->telegram_link)
                            <a href="https://t.me/{{$store->telegram_link}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <i class="fab fa-telegram"></i>
                            </a>
                        @endif
                        @if($store->whatsapp_number)
                            <a href="https://api.whatsapp.com/send?phone={{$store->whatsapp_number}}/" target="__blank"
                               type="button" class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <i class="fab fa-whatsapp"></i>
                            </a>
                        @endif
                        @if($store->phone_number)
                            <a href="tel:{{$store->phone_number}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        @if($store->facebook_user)
                            <a href="https://facebook.com/{{$store->facebook_user}}" target="__blank" type="button"
                               class="btn btn btn-icon btn-icon rounded-circle btn-outline-dark mb-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
