...
Route::get('login', [AuthController::class, 'adminLoginForm'])->name('login')->middleware('guest');
Route::get('register', [AuthController::class, 'adminRegisterForm'])->name('register')->middleware('guest');
