<div>
    <form class="form" wire:submit.prevent="save">
        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-1">
                    <textarea class="form-control" id="exampleFormControlTextarea1" wire:model.defer="store_desc" rows="3" placeholder="{{__('Enter Description')}}">{{$store->store_desc ?? null}}</textarea>
            ...
            <div class="col-lg-6 col-md-12 mb-2">
                ...
                <div class="input-group" data-bs-toggle="modal" data-bs-target="#storeAddress">
                    ...
                    <input type="text" class="form-control" placeholder="{{__('Select The City')}}" wire:model.defer="city_id" aria-label="Amount">
