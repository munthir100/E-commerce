        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="mb-1">
                    ...
                    <input type="text" id="first-name-column" class="form-control" placeholder="Store Name" wire:model="store_name" />
            ...
            <div class="col-md-6 col-12">
                <div class="mb-1">
                    ...
                    <input type="text" id="last-name-column" class="form-control" placeholder="Store Link" wire:model="store_link" />
