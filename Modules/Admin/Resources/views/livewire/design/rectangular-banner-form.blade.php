<div>
    <div id="first-part" class="mb-2">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" wire:model="externalLink" id="inlineCheckbox1">
        ...
        <div class="row">
            <div class="col-12">
                <input type="text" class="form-control" placeholder="External link URL" wire:model="externalLinkUrl">
            </div>
        </div>
        @endif
