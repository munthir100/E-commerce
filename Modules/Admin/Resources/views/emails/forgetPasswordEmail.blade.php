...
<head>
    ...
    <title>Verify Email Basic - {{('Restone')}} - Bootstrap HTML admin template</title>
                ...
                <div class="auth-inner my-2">
                    ...
                    <div class="card mb-0 col-lg-12">
                        <div class="card-body">
                            ...
                            <h2 class="card-title fw-bolder mb-1">Reset your password ✉️</h2>
                            <p class="card-text mb-2">
                                You recently requested to reset your password from.  <span
                                    class="fw-bolder">https://rstonesa.com</span> Please follow the
                                Please click on the button below to reset your password
                            </p>

                            <a href="{{ url('/resetPassword?token=' . $token . '&email=' . $email) }}" class="btn btn-primary w-100">Reset password</a>

                            <p class="text-center mt-2">
                                <span>If you did not make this request, please ignore this email. </span>
                            </p>
                        </div>
                    </div>
                    <!-- / verify email basic -->
