<div>
    <form class="auth-login-form mt-2" method="POST" wire:submit.prevent="login">
        <div class="mb-1">
            ...
            <input type="text" class="form-control" wire:model.defer="username" placeholder="{{__('email or phone number')}}" autofocus />
        ...
        <div class="mb-1">
            ...
            <div class="input-group input-group-merge form-password-toggle">
                <input type="password" class="form-control form-control-merge" wire:model.defer="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="login-password" />
