...
<head>
    ...
    <title>@yield('title',translate('Welcome'))</title>
    <!--====== Favicon Icon ======-->
            ...
            <div class="panel-inner">
                ...
                <nav class="mobile-menu">
                    <ul>
                        ...
                        @auth
                        <li>
                            <a href="{{ url('/admin') }}" class=""> <i class="far fa-user-circle"></i> Dashboard </a>
                        </li>
                        @else
                        <li>
                            <a href="{{route('login')}}" class=""> تسجيل دخول </a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="widget text-block-widget">
                            ...
                            <p>بدون خبرة تقنية وبكل سهولة يمكنك البيع في أي مكان وزمان بمتجر إلكتروني خاص بك وبهويتك التجارية</p>
                        </div>
